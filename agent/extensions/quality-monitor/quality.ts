/**
 * Quality assessment logic for the quality-monitor extension.
 *
 * Detects common failure modes in model responses: empty outputs,
 * hallucinated tool names, repeated tool calls (loops), and malformed args.
 */
...
export function buildCorrectionMessage(reason: string): string {
  ...
  if (reason.startsWith("unknown_tool:")) {
    ...
    return (
      ...
      "Please use one of the available tools listed in your instructions."
    );
  }
